...
\title[Short title]{Métodos y Técnicas de Gamificación Implementadas en Educación: Revisión Sistemática} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\medskip
\textit{luishdezlazaro@hotmail.com} % Your email address
}
